<template>
  ...
  >
    <div
      class="shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)] w-3/5 h-4/5 flex rounded-xl overflow-hidden"
    ...
    >
      ...
      <section
        class="w-3/5 bg-white flex flex-col items-center rounded-2xl py-10"
      >
        <slot />
        <div class="mt-8">
